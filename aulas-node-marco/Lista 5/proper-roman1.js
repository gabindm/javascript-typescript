...
function proper_name(full_name)
{
    ...
    try {
        if (roman.toArabic) { //se nome for conversível pra número, ele segue as instrucoes do try. mas se nao for conversivel, vai retornar throw e ir pro catch
            result.push(ultimo_nome.toUpperCase())
       }
    }
    catch(e) {
